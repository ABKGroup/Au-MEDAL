...
create_operating_condition LIB_results
set_opc_temperature LIB_results 25.0
set_opc_default_voltage LIB_results 0.7
set_opc_process LIB_results [subst {
    { .lib './hspice/7nm_TT.lib' TT}
}]

add_opc_supplies LIB_results VDD 0.70
add_opc_grounds LIB_results VSS 0
