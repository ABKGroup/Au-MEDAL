...
C {sg13_lv_nmos.sym} 0 420 0 0 {name=MN3 w=2.96u l=130.00n ng=4 m=1 model=sg13_lv_nmos spiceprefix=X}
...
C {sg13_lv_pmos.sym} 0 180 0 0 {name=MP0 w=4.48u l=130.00n ng=4 m=1 model=sg13_lv_pmos spiceprefix=X}
...
C {sg13_lv_pmos.sym} 260 180 0 0 {name=MP1 w=4.48u l=130.00n ng=4 m=1 model=sg13_lv_pmos spiceprefix=X}
...
C {sg13_lv_pmos.sym} 0 60 0 0 {name=MP3 w=4.48u l=130.00n ng=4 m=1 model=sg13_lv_pmos spiceprefix=X}
