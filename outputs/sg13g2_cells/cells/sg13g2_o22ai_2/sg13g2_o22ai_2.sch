...
C {au_medal_sg13_lv_nmos.sym} 260 540 0 0 {name=MN3 w=1.48u l=130.00n ng=2 model=sg13_lv_nmos spiceprefix=X}
...
C {au_medal_sg13_lv_pmos.sym} 0 60 0 0 {name=MP1 w=2.24u l=130.00n ng=2 model=sg13_lv_pmos spiceprefix=X}
...
C {au_medal_sg13_lv_pmos.sym} 260 180 0 0 {name=MP2 w=2.24u l=130.00n ng=2 model=sg13_lv_pmos spiceprefix=X}
