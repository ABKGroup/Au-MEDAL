...
C {sg13_lv_pmos.sym} 780 180 0 0 {name=MP5 w=4.48u l=130.00n ng=4 m=1 model=sg13_lv_pmos spiceprefix=X}
...
C {sg13_lv_nmos.sym} 780 420 0 0 {name=MN5 w=2.96u l=130.00n ng=4 m=1 model=sg13_lv_nmos spiceprefix=X}
