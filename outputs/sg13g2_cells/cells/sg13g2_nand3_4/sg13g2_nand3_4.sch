...
C {lab_wire.sym} 100 300 0 0 {name=l7 sig_type=std_logic lab=VSS}
C {lab_wire.sym} -100 300 0 0 {name=l8 sig_type=std_logic lab=A}
C {lab_wire.sym} 100 420 0 0 {name=l9 sig_type=std_logic lab=VSS}
C {lab_wire.sym} -100 420 0 0 {name=l10 sig_type=std_logic lab=B}
C {lab_wire.sym} 100 540 0 0 {name=l11 sig_type=std_logic lab=VSS}
C {lab_wire.sym} -100 540 0 0 {name=l12 sig_type=std_logic lab=C}
...
C {sg13_lv_nmos.sym} 0 300 0 0 {name=MN0 w=2.96u l=130.00n ng=4 m=1 model=sg13_lv_nmos}
