...
C {au_medal_sg13_lv_nmos.sym} 260 420 0 0 {name=MN0 w=2.96u l=130.00n ng=4 model=sg13_lv_nmos spiceprefix=X embed=true}
[
...
C {au_medal_sg13_lv_pmos.sym} 0 180 0 0 {name=MP2 w=4.48u l=130.00n ng=4 model=sg13_lv_pmos spiceprefix=X embed=true}
[
v {xschem version=3.4.8RC file_version=1.3
* Modified 2026-09-15 by Au-MEDAL contributors: removed multiplier
* parameter from netlisting formats, default properties and visible text.
...
C {au_medal_sg13_lv_pmos.sym} 260 60 0 0 {name=MP1 w=4.48u l=130.00n ng=4 model=sg13_lv_pmos spiceprefix=X}
