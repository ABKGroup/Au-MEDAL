...
C {lab_wire.sym} -100 420 0 0 {name=l8 sig_type=std_logic lab=A1}
...
C {lab_wire.sym} 160 420 0 0 {name=l12 sig_type=std_logic lab=B1}
...
C {sg13_lv_nmos.sym} 0 420 0 0 {name=MN1 w=2.96u l=130.00n ng=4 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 0 540 0 0 {name=MN2 w=2.96u l=130.00n ng=4 m=1 model=sg13_lv_nmos}
C {sg13_lv_nmos.sym} 260 420 0 0 {name=MN0 w=2.96u l=130.00n ng=4 m=1 model=sg13_lv_nmos}
C {sg13_lv_pmos.sym} 0 60 0 0 {name=MP0 w=4.48u l=130.00n ng=4 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 260 60 0 0 {name=MP1 w=4.48u l=130.00n ng=4 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 0 180 0 0 {name=MP2 w=4.48u l=130.00n ng=4 m=1 model=sg13_lv_pmos}
