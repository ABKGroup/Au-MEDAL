...
S {}
E {}
T {sg13g2_a21oi_2} -240 -80 0 0 0.4 0.4 {}
N -240 260 -200 260 {}
N -240 300 -200 300 {}
N -240 340 -200 340 {}
N -100 60 -20 60 {}
...
C {au_medal_sg13_lv_nmos.sym} 260 420 0 0 {name=MN0 w=1.48u l=130.00n ng=2 model=sg13_lv_nmos spiceprefix=X embed=true}
[
...
C {au_medal_sg13_lv_pmos.sym} 0 180 0 0 {name=MP2 w=2.24u l=130.00n ng=2 model=sg13_lv_pmos spiceprefix=X embed=true}
[
v {xschem version=3.4.8RC file_version=1.3
* Modified 2026-09-15 by Au-MEDAL contributors: removed multiplier
* parameter from netlisting formats, default properties and visible text.
