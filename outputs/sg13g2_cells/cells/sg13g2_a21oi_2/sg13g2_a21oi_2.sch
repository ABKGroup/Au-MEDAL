...
C {sg13_lv_nmos.sym} 260 420 0 0 {name=MN0 w=1.48u l=130.00n ng=2 m=1 model=sg13_lv_nmos spiceprefix=X}
...
C {sg13_lv_pmos.sym} 0 180 0 0 {name=MP2 w=2.24u l=130.00n ng=2 m=1 model=sg13_lv_pmos spiceprefix=X}
