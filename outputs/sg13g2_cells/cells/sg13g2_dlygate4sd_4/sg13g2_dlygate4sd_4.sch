...
C {au_medal_sg13_lv_pmos.sym} 780 60 0 0 {name=MP3 w=4.48u l=130.00n ng=4 model=sg13_lv_pmos spiceprefix=X embed=true}
[
...
C {au_medal_sg13_lv_pmos.sym} 520 60 0 0 {name=MP2 w=1.000u l=130.00n ng=1 model=sg13_lv_pmos spiceprefix=X}
C {lab_wire.sym} 360 20 0 0 {name=l7 sig_type=std_logic lab=VDD}
C {au_medal_sg13_lv_pmos.sym} 260 60 0 0 {name=MP1 w=1.000u l=130.00n ng=1 model=sg13_lv_pmos spiceprefix=X}
C {lab_wire.sym} 100 20 0 0 {name=l9 sig_type=std_logic lab=VDD}
C {au_medal_sg13_lv_pmos.sym} 0 60 0 0 {name=MP0 w=420.00n l=130.00n ng=1 model=sg13_lv_pmos spiceprefix=X}
C {lab_wire.sym} 880 260 0 0 {name=l11 sig_type=std_logic lab=VSS}
C {au_medal_sg13_lv_nmos.sym} 780 300 0 0 {name=MN3 w=2.96u l=130.00n ng=4 model=sg13_lv_nmos spiceprefix=X embed=true}
[
v {xschem version=3.4.8RC file_version=1.3
* Modified 2026-09-15 by Au-MEDAL contributors: removed multiplier
* parameter from netlisting formats, default properties and visible text.
...
C {au_medal_sg13_lv_nmos.sym} 520 300 0 0 {name=MN2 w=420.00n l=130.00n ng=1 model=sg13_lv_nmos spiceprefix=X}
C {lab_wire.sym} 360 260 0 0 {name=l15 sig_type=std_logic lab=VSS}
C {au_medal_sg13_lv_nmos.sym} 260 300 0 0 {name=MN1 w=420.00n l=130.00n ng=1 model=sg13_lv_nmos spiceprefix=X}
C {lab_wire.sym} 100 260 0 0 {name=l17 sig_type=std_logic lab=VSS}
C {au_medal_sg13_lv_nmos.sym} 0 300 0 0 {name=MN0 w=420.00n l=130.00n ng=1 model=sg13_lv_nmos spiceprefix=X}
