...
S {}
E {}
T {sg13g2_o21ai_2} -240 -80 0 0 0.4 0.4 {}
N -240 260 -200 260 {}
N -240 300 -200 300 {}
N -240 340 -200 340 {}
N -100 60 -20 60 {}
...
N 290 500 290 540 {}
N 290 500 360 500 {}
C {lab_wire.sym} 100 120 0 0 {name=l0 sig_type=std_logic lab=net14}
C {lab_wire.sym} 360 480 0 0 {name=l1 sig_type=std_logic lab=net1}
C {lab_wire.sym} 100 20 0 0 {name=l2 sig_type=std_logic lab=VDD}
C {lab_wire.sym} -100 60 0 0 {name=l3 sig_type=std_logic lab=A1}
C {au_medal_sg13_lv_pmos.sym} 0 60 0 0 {name=MP0 w=2.24u l=130.00n ng=2 model=sg13_lv_pmos spiceprefix=X embed=true}
[
...
C {lab_wire.sym} 100 140 0 0 {name=l5 sig_type=std_logic lab=VDD}
C {lab_wire.sym} -100 180 0 0 {name=l6 sig_type=std_logic lab=A2}
C {au_medal_sg13_lv_pmos.sym} 0 180 0 0 {name=MP1 w=2.24u l=130.00n ng=2 model=sg13_lv_pmos spiceprefix=X}
C {lab_wire.sym} 360 20 0 0 {name=l8 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 160 60 0 0 {name=l9 sig_type=std_logic lab=B1}
C {au_medal_sg13_lv_pmos.sym} 260 60 0 0 {name=MP2 w=2.24u l=130.00n ng=2 model=sg13_lv_pmos spiceprefix=X}
C {lab_wire.sym} 360 500 0 0 {name=l11 sig_type=std_logic lab=VSS}
C {lab_wire.sym} 160 540 0 0 {name=l12 sig_type=std_logic lab=A2}
C {au_medal_sg13_lv_nmos.sym} 260 540 0 0 {name=MN0 w=1.48u l=130.00n ng=2 model=sg13_lv_nmos spiceprefix=X embed=true}
[
v {xschem version=3.4.8RC file_version=1.3
* Modified 2026-09-15 by Au-MEDAL contributors: removed multiplier
* parameter from netlisting formats, default properties and visible text.
...
C {lab_wire.sym} -100 540 0 0 {name=l15 sig_type=std_logic lab=A1}
C {au_medal_sg13_lv_nmos.sym} 0 540 0 0 {name=MN2 w=1.48u l=130.00n ng=2 model=sg13_lv_nmos spiceprefix=X}
C {lab_wire.sym} 100 380 0 0 {name=l17 sig_type=std_logic lab=VSS}
C {lab_wire.sym} -100 420 0 0 {name=l18 sig_type=std_logic lab=B1}
C {au_medal_sg13_lv_nmos.sym} 0 420 0 0 {name=MN1 w=1.48u l=130.00n ng=2 model=sg13_lv_nmos spiceprefix=X}
