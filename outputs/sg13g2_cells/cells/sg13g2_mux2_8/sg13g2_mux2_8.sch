...
S {}
E {}
T {sg13g2_mux2_8} -240 -80 0 0 0.4 0.4 {}
N -240 220 -200 220 {}
N -240 260 -200 260 {}
N -240 300 -60 300 {}
N -60 180 -60 300 {}
...
C {sg13_lv_pmos.sym} 780 180 0 0 {name=MP5 w=8.96u l=130.00n ng=8 m=1 model=sg13_lv_pmos spiceprefix=X}
...
C {sg13_lv_pmos.sym} 520 180 0 0 {name=MP4 w=1.000u l=130.00n ng=1 m=1 model=sg13_lv_pmos spiceprefix=X}
...
C {sg13_lv_pmos.sym} 520 60 0 0 {name=MP3 w=1.000u l=130.00n ng=1 m=1 model=sg13_lv_pmos spiceprefix=X}
...
C {sg13_lv_pmos.sym} 260 180 0 0 {name=MP2 w=1.000u l=130.00n ng=1 m=1 model=sg13_lv_pmos spiceprefix=X}
...
C {sg13_lv_nmos.sym} 520 540 0 0 {name=MN4 w=740.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos spiceprefix=X}
...
C {sg13_lv_nmos.sym} 260 540 0 0 {name=MN2 w=740.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos spiceprefix=X}
C {lab_wire.sym} 880 380 0 0 {name=l28 sig_type=std_logic lab=VSS}
C {sg13_lv_nmos.sym} 780 420 0 0 {name=MN5 w=5.92u l=130.00n ng=8 m=1 model=sg13_lv_nmos spiceprefix=X}
