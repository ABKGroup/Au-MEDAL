...
C {au_medal_sg13_lv_pmos.sym} 780 180 0 0 {name=MP5 w=8.96u l=130.00n ng=8 model=sg13_lv_pmos spiceprefix=X}
...
C {au_medal_sg13_lv_nmos.sym} 780 420 0 0 {name=MN5 w=5.92u l=130.00n ng=8 model=sg13_lv_nmos spiceprefix=X}
