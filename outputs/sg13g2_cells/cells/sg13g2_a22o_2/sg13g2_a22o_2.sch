...
C {sg13_lv_nmos.sym} 520 420 0 0 {name=MN4 w=1.48u l=130.00n ng=2 m=1 model=sg13_lv_nmos}
...
C {sg13_lv_pmos.sym} 520 180 0 0 {name=MP4 w=2.24u l=130.00n ng=2 m=1 model=sg13_lv_pmos}
