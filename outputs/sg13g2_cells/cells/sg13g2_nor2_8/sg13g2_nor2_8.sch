...
S {}
E {}
T {sg13g2_nor2_8} -240 -80 0 0 0.4 0.4 {}
N -240 280 -200 280 {}
N -240 320 -200 320 {}
N -100 60 -20 60 {}
N -100 180 -20 180 {}
...
C {au_medal_sg13_lv_nmos.sym} 0 420 0 0 {name=MN0 w=5.92u l=130.00n ng=8 model=sg13_lv_nmos spiceprefix=X embed=true}
[
...
C {au_medal_sg13_lv_nmos.sym} 260 420 0 0 {name=MN1 w=5.92u l=130.00n ng=8 model=sg13_lv_nmos spiceprefix=X}
C {lab_wire.sym} 100 20 0 0 {name=l7 sig_type=std_logic lab=VDD}
C {lab_wire.sym} -100 60 0 0 {name=l8 sig_type=std_logic lab=A}
C {au_medal_sg13_lv_pmos.sym} 0 60 0 0 {name=MP0 w=8.96u l=130.00n ng=8 model=sg13_lv_pmos spiceprefix=X embed=true}
[
v {xschem version=3.4.8RC file_version=1.3
* Modified 2026-09-15 by Au-MEDAL contributors: removed multiplier
* parameter from netlisting formats, default properties and visible text.
...
C {au_medal_sg13_lv_pmos.sym} 0 180 0 0 {name=MP1 w=8.96u l=130.00n ng=8 model=sg13_lv_pmos spiceprefix=X}
