...
C {sg13_lv_nmos.sym} 0 420 0 0 {name=MN0 w=5.92u l=130.00n ng=8 m=1 model=sg13_lv_nmos spiceprefix=X}
C {lab_wire.sym} 360 380 0 0 {name=l4 sig_type=std_logic lab=VSS}
C {lab_wire.sym} 160 420 0 0 {name=l5 sig_type=std_logic lab=B}
C {sg13_lv_nmos.sym} 260 420 0 0 {name=MN1 w=5.92u l=130.00n ng=8 m=1 model=sg13_lv_nmos spiceprefix=X}
...
C {sg13_lv_pmos.sym} 0 180 0 0 {name=MP1 w=8.96u l=130.00n ng=8 m=1 model=sg13_lv_pmos spiceprefix=X}
