...
C {lab_wire.sym} 360 420 0 0 {name=l9 sig_type=std_logic lab=VSS}
C {lab_wire.sym} 160 420 0 0 {name=l10 sig_type=std_logic lab=A2}
C {lab_wire.sym} 100 540 0 0 {name=l11 sig_type=std_logic lab=VSS}
C {lab_wire.sym} -100 540 0 0 {name=l12 sig_type=std_logic lab=B1}
C {lab_wire.sym} 620 180 0 0 {name=l13 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 620 420 0 0 {name=l14 sig_type=std_logic lab=VSS}
...
C {sg13_lv_pmos.sym} 260 60 0 0 {name=MP2 w=1.12u l=130.00n ng=1 m=1 model=sg13_lv_pmos}
C {sg13_lv_pmos.sym} 520 180 0 0 {name=MP3 w=1.12u l=130.00n ng=1 m=1 model=sg13_lv_pmos}
