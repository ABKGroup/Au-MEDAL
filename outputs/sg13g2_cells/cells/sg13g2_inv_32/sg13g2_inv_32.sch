...
C {au_medal_sg13_lv_nmos.sym} 0 300 0 0 {name=MN0 w=23.68u l=130.00n ng=32 model=sg13_lv_nmos spiceprefix=X embed=true}
[
...
C {au_medal_sg13_lv_pmos.sym} 0 60 0 0 {name=MP0 w=35.84u l=130.00n ng=32 model=sg13_lv_pmos spiceprefix=X embed=true}
[
v {xschem version=3.4.8RC file_version=1.3
* Modified 2026-09-15 by Au-MEDAL contributors: removed multiplier
* parameter from netlisting formats, default properties and visible text.
