...
C {au_medal_sg13_lv_pmos.sym} 780 60 0 0 {name=MP4 w=4.48u l=130.00n ng=4 model=sg13_lv_pmos spiceprefix=X embed=true}
[
...
C {au_medal_sg13_lv_pmos.sym} 520 180 0 0 {name=MP3 w=4.48u l=130.00n ng=4 model=sg13_lv_pmos spiceprefix=X}
C {lab_wire.sym} 620 20 0 0 {name=l10 sig_type=std_logic lab=VDD}
C {lab_wire.sym} 420 60 0 0 {name=l11 sig_type=std_logic lab=A}
C {au_medal_sg13_lv_pmos.sym} 520 60 0 0 {name=MP2 w=4.48u l=130.00n ng=4 model=sg13_lv_pmos spiceprefix=X}
...
C {au_medal_sg13_lv_pmos.sym} 260 180 0 0 {name=MP1 w=840.00n l=130.00n ng=1 model=sg13_lv_pmos spiceprefix=X}
...
C {au_medal_sg13_lv_nmos.sym} 520 420 0 0 {name=MN3 w=2.96u l=130.00n ng=4 model=sg13_lv_nmos spiceprefix=X embed=true}
[
v {xschem version=3.4.8RC file_version=1.3
* Modified 2026-09-15 by Au-MEDAL contributors: removed multiplier
* parameter from netlisting formats, default properties and visible text.
...
C {au_medal_sg13_lv_nmos.sym} 0 540 0 0 {name=MN1 w=640.00n l=130.00n ng=1 model=sg13_lv_nmos spiceprefix=X}
...
C {au_medal_sg13_lv_nmos.sym} 0 420 0 0 {name=MN0 w=640.00n l=130.00n ng=1 model=sg13_lv_nmos spiceprefix=X}
...
C {au_medal_sg13_lv_nmos.sym} 780 540 0 0 {name=MN4 w=2.96u l=130.00n ng=4 model=sg13_lv_nmos spiceprefix=X}
...
C {au_medal_sg13_lv_nmos.sym} 520 540 0 0 {name=MN2 w=2.96u l=130.00n ng=4 model=sg13_lv_nmos spiceprefix=X}
