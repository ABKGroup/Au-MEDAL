...
S {}
E {}
T {sg13g2_a22o_1} -240 -80 0 0 0.4 0.4 {}
N -240 240 -200 240 {}
N -240 280 -200 280 {}
N -240 320 -200 320 {}
N -240 360 -200 360 {}
...
C {lab_wire.sym} 360 120 0 0 {name=l1 sig_type=std_logic lab=net4}
C {lab_wire.sym} 100 480 0 0 {name=l2 sig_type=std_logic lab=net2}
...
C {au_medal_sg13_lv_nmos.sym} 520 420 0 0 {name=MN4 w=740.00n l=130.00n ng=1 model=sg13_lv_nmos spiceprefix=X}
C {lab_wire.sym} 620 140 0 0 {name=l30 sig_type=std_logic lab=VDD}
C {au_medal_sg13_lv_pmos.sym} 520 180 0 0 {name=MP4 w=1.12u l=130.00n ng=1 model=sg13_lv_pmos spiceprefix=X}
...
C {devices/iopin.sym} 780 600 0 0 {name=p7 lab=VSS}
