...
C {sg13_lv_nmos.sym} 520 420 0 0 {name=MN4 w=740.00n l=130.00n ng=1 m=1 model=sg13_lv_nmos spiceprefix=X}
C {lab_wire.sym} 620 140 0 0 {name=l30 sig_type=std_logic lab=VDD}
C {sg13_lv_pmos.sym} 520 180 0 0 {name=MP4 w=1.12u l=130.00n ng=1 m=1 model=sg13_lv_pmos spiceprefix=X}
