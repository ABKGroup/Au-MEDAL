...
S {}
E {}
T {sg13g2_nand2_8} -240 -80 0 0 0.4 0.4 {}
N -240 160 -200 160 {}
N -240 200 -200 200 {}
N -100 60 -20 60 {}
N -100 300 -20 300 {}
...
C {au_medal_sg13_lv_pmos.sym} 260 60 0 0 {name=MP1 w=8.96u l=130.00n ng=8 model=sg13_lv_pmos spiceprefix=X embed=true}
[
...
C {au_medal_sg13_lv_pmos.sym} 0 60 0 0 {name=MP0 w=8.96u l=130.00n ng=8 model=sg13_lv_pmos spiceprefix=X}
C {lab_wire.sym} 100 380 0 0 {name=l7 sig_type=std_logic lab=VSS}
C {lab_wire.sym} -100 420 0 0 {name=l8 sig_type=std_logic lab=B}
C {au_medal_sg13_lv_nmos.sym} 0 420 0 0 {name=MN1 w=5.92u l=130.00n ng=8 model=sg13_lv_nmos spiceprefix=X embed=true}
[
v {xschem version=3.4.8RC file_version=1.3
* Modified 2026-09-15 by Au-MEDAL contributors: removed multiplier
* parameter from netlisting formats, default properties and visible text.
...
C {au_medal_sg13_lv_nmos.sym} 0 300 0 0 {name=MN0 w=5.92u l=130.00n ng=8 model=sg13_lv_nmos spiceprefix=X}
