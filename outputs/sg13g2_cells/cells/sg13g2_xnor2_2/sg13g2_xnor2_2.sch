...
S {}
E {}
T {sg13g2_xnor2_2} -240 -80 0 0 0.4 0.4 {}
N -240 280 -200 280 {}
N -240 320 -200 320 {}
N -100 180 -20 180 {}
N -100 420 -20 420 {}
...
C {au_medal_sg13_lv_pmos.sym} 780 60 0 0 {name=MP4 w=2.24u l=130.00n ng=2 model=sg13_lv_pmos spiceprefix=X embed=true}
[
...
C {au_medal_sg13_lv_nmos.sym} 520 420 0 0 {name=MN3 w=1.48u l=130.00n ng=2 model=sg13_lv_nmos spiceprefix=X embed=true}
[
v {xschem version=3.4.8RC file_version=1.3
* Modified 2026-09-15 by Au-MEDAL contributors: removed multiplier
* parameter from netlisting formats, default properties and visible text.
...
C {au_medal_sg13_lv_nmos.sym} 780 540 0 0 {name=MN4 w=1.48u l=130.00n ng=2 model=sg13_lv_nmos spiceprefix=X}
